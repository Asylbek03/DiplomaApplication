...
import com.example.diplomaapplication.databinding.FragmentAddMedicineChatBinding
...
class AddMedicineFragmentChat : DialogFragment(), MedicineFormInterface, DatabaseError {

    private lateinit var medicine: Medicine
    private lateinit var medicinesViewModel: MedicinesViewModel
    private lateinit var alarmManager: AlarmManager
    private lateinit var medicineDao: MedicineDao
    private var _binding: FragmentAddMedicineChatBinding? = null
    ...
    private val statusInfo = "Пациент добавил напоминание"
    private val pendingIntentsMap = HashMap<Int, PendingIntent>()

    companion object {
        fun newInstance(currentUserViewModel: CurrentUserViewModel, requestViewModel: RequestViewModel, request: Request): AddMedicineFragmentChat {
            val fragment = AddMedicineFragmentChat()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        _binding = FragmentAddMedicineChatBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupDateAndTimePicker() {
        val dateTimePickerViewModel: DateTimePickerViewModel = ViewModelProvider(requireActivity()).get(
    ...
    private fun sendMessageToChat(message: String) {
        try {
            if (::request.isInitialized) {
                ...
                Log.e(ContentValues.TAG, "Error sending message: Request has not been initialized")
                errorHandled("Error sending message: Request has not been initialized", requireView())
            }
        } catch (ex: Exception) {
            Log.e(ContentValues.TAG, "Error sending message: ${ex.message}", ex)
